...
.field-input:focus { border-color: var(--accent-line); background: var(--bg-3); }
.field-textarea { min-height: 70px; resize: vertical; font-family: inherit; line-height: 1.5; }
...
.btn-ghost:hover { border-color: var(--border-0); }
.btn-danger { color: oklch(0.68 0.14 25); border-color: oklch(0.45 0.08 25); background: transparent; }
.btn-danger:hover { background: oklch(0.28 0.06 25); color: oklch(0.78 0.13 25); }
</style>
